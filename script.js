...
firstArray.push('geel');
console.log(firstArray);
firstArray.push(5);
firstArray.push({ greeting: 'Hi ik ben een object' });
console.log(firstArray);
console.log(firstArray[firstArray.length - 1].greeting);
...
console.log("Eerste temperament kat 2:", catBreeds[1].temperament)
